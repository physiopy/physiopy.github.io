...
Phys2bids codebase is licensed under the Apache License, Version 2.0. The full license can be found in the [LICENSE](https://github.com/physiopy/phys2bids/blob/master/LICENSE) file in the phys2bids distribution. You may also obtain a copy of the license [here](http://www.apache.org/licenses/LICENSE-2.0).